...
$select = $moscourier_options['sections-banner-select'];
$slides = $moscourier_options['sections-banner-details'];
$shortcode = $moscourier_options['sections-banner-shortcode'];
$n = 1;
