...
function moscourier_metaboxes() {
    ...
    if (@$_GET['post'] == $blog_id){
        ...
        $enabled = ($moscourier_options['general-page-sections']['Enabled']) ? $moscourier_options['general-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($moscourier_options['general-page-sections']['Disabled']) ? $moscourier_options['general-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
...
add_action('cmb2_admin_init', 'moscourier_metaboxes');