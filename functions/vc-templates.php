...
function navigation_func( $atts = array(), $content = '' ) {
	...
	if ($atts['menu_name']) :
				...
				if ($atts['logo'] == 'yes') :
					...
					$html .= '<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#'.$atts['container_id'].'" aria-controls="collapsibleNavbar" aria-expanded="false" aria-label="Toggle navigation">
