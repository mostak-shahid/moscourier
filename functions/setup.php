<?php
//Add theme setup
if ( ! function_exists( 'moscourier_setup' ) ) :
	function moscourier_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => __('Main Menu', 'moscourier'),
			'mobilemenu' => __('Mobile Menu', 'moscourier'),
		));
...
add_action( 'after_setup_theme', 'moscourier_setup' );